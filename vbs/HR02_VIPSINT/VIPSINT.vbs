...
oRX.Pattern = "wscript"
oRX.IgnoreCase = True 
Dim arrFeedback : arrFeedback = Array("Invalid date format","Nope, that's not right format either","Nope, bad format again","Can you read ?!","Are you kidding me ?!","Piss off, twat !")
