...
Dim UPLOAD_TO_SAP : UPLOAD_TO_SAP = True
...
oRX.Pattern = "wscript"
oRX.IgnoreCase = True 
Dim arrFeedback : arrFeedback = Array("Invalid date format","Nope, that's not right format either","Nope, bad format again","Can you read ?!","Are you fucking kidding me ?!","Piss off, twat !")
...
oMAIL.AddAdmin = "tomas.chudik@volvo.com"
oMAILB.AddAdmin = "tomas.chudik@volvo.com"
...
If oRX.Test(LCase(WScript.FullName)) Then ' wscript
	...
	If UPLOAD_TO_SAP Then 
		'Get SAP system name
		strSAPsys = InputBox("Enter SAP system name","SAP system name","FQ2")
		If strSAPsys = "" Then WScript.Quit ' Quit silently. Can't continue without SAP system name
		
		'Get SAP client number
		strSAPcli = InputBox("Enter SAP client number","SAP client number","105")
...
ElseIf oFSO.FileExists(sWorkingDirectory & "\SOURCE\" & sOutFilePrefixAP & sOutFileName & sOutFileSuffixAP) Then
...
ElseIf oFSO.FileExists(sWorkingDirectory & "\SOURCE\" & sOutFilePrefixAPC & sOutFileName & sOutFileSuffixAPC) Then
...
Function ProcessSupplierCredit(strPath,ByRef arrFiles)
	...
	Dim boolProcess : boolProcess = False ' Set to true if at least one entry foun in the I file and therefore there is stuff to process
