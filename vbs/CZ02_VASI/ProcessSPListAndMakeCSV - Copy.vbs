	...
	Public Function Consume(xmlNode__,xmlConfigNode__)
		...
		Select Case UCase(xmlNode__.SelectSingleNode("content").selectSingleNode("m:properties").selectSingleNode("d:DocType").text)
			...
			Case "OUT"
				...
				'***********************************
				If (CDbl(Replace(xmlNode__.SelectSingleNode("content").SelectSingleNode("m:properties").SelectSingleNode("d:TotalAdminCharge").text,".",",")) > 0 And CBool(xmlConfigNode__.SelectSingleNode("//AdminChargeSeparate").text)) Or _
				   (CDbl(Replace(xmlNode__.SelectSingleNode("content").SelectSingleNode("m:properties").SelectSingleNode("d:TotalAdminCharge").text,".",",")) > 0 And UCase(xmlNode__.SelectSingleNode("content").SelectSingleNode("m:properties").SelectSingleNode("d:DefTempl").text) = "NO") Then
					'Build GL Line1
					'DocDate -> line item (1)
